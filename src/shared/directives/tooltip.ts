...
import { computePosition, type ComputePositionConfig, flip, offset, type Placement } from '@floating-ui/dom';
import type { TooltipBinding } from './types/tooltip-binding';
